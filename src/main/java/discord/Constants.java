...
public class Constants {
    ...
    public static final String DISCORD_BOT_TOKEN = "OTUwNDc4ODc1NDg4NTc5NjU1.YiZgbg.FS-GH54fXWUKC4IYkyyRBLJX-yk";
    ...
    public static final String SEARCH_CHANNEL_ID = "958170140296495136";
    public static final String MOD_LOGIN_CHANNEL_ID = "958232818507452478";
    public static final String MOD_WHITELIST_CHANNEL_ID = "958753281071546378";
    public static final String BAN_LOG_CHANNEL_ID = "629250644192002050";
