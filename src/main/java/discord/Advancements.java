...
public class Advancements {
    ...
    public static void setAdvancements() {
        ...
        advancements.add(new Advancement("minecraft:adventure/trade", "What a Deal","Take an item from a villager or wandering trader's trading output slot, and put it in your inventory."));
        ...
        advancements.add(new Advancement("minecraft:story/root", "Story Advancement","Have a crafting table in your inventory."));
    ...
    public static void setPlayerCompletedAdvancementsOnLogin(Player player) throws IOException {
        ...
        while (advancements.hasNext()) {
            ...
            for (Advancement latchAdvancement : getAdvancements()) {
