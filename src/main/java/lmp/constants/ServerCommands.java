...
public class ServerCommands {
    ...
    public static final String DISCORD_ADMIN_CHAT_COMMAND = "adsc";
    public static final String BACKPACK_COMMAND = "bp";
    public static final String PLAYER_SHOP_COMMAND = "ps";
