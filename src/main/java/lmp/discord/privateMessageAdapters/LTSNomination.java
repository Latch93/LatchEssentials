...
public class LTSNomination extends ListenerAdapter {
    ...
    public void onMessageReceived(MessageReceivedEvent event) {
        ...
        List<String> ltsNominationQuestions = new LinkedList<>();
         ltsNominationQuestions.add("1.) What category of Overpowered item do you nominate? Armor/Tool/Weapon?");
        ltsNominationQuestions.add("2.) What type of item is your nomination? Chestplate/Bow/Pickaxe?");
        ltsNominationQuestions.add("3.) What enchantments would you like to see on your item?");
        ltsNominationQuestions.add("4.) What is the name of your Overpowered nomination?");
        ltsNominationQuestions.add("5.) What block do you nominate?");
        ltsNominationQuestions.add("6.) What additional block or head do you nominate, if any? (Type 'None' if none)");
